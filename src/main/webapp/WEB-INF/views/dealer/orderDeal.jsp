...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${base}/dealer/orderDeal?id=${order.id}">订单处理</a></li>
	</ul>
	<br />
<%@include file="/WEB-INF/views/common/message.jsp"%>
	<form id="inputForm" class="form-horizontal"
		action="${base}/dealer/orderDeal" method="post">
...
<c:forEach items='${keys}' var='key'>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="usedDate" name="usedDate" type="text" readonly="readonly"
...
<c:if test="${order.status == 0}">
			<a id="btnDiscard" class="btn btn-primary" href="${base}/dealer/orderDiscard?id=${order.id}">
				废 弃</a>&nbsp;
</c:if>
