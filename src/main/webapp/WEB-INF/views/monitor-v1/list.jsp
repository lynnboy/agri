...
function newstatus(data, title, func) {
	top.$.jBox.open("iframe:${base}${basepath}newstatus/" + data.id, title,
...
function submit(id, subject, tags, remarks) {
	...
	newstatus(data, "提交" + subject, function(newdata) {
...
function accept(id, subject, tags, remarks) {
	var data = {
		...
		newstatus(data, "接受" + subject, function(newdata) {
...
function reject(id, subject, tags, remarks) {
	var data = {
		...
		newstatus(data, "打回" + subject, function(newdata) {
...
function withdraw(id, subject, tags, remarks) {
	var data = {
		...
		newstatus(data, "撤回" + subject, function(newdata) {
