...
<%@include file="/WEB-INF/views/common/message.jsp"%>
	<form id="inputForm" class="form-horizontal"
		...
		<div class="control-group">
			<label for="地块地址" class="control-label">乡、镇、街道:</label>
			<div class="controls">
				<input id="地块地址" name="地块地址" class="required input-small" type="text"
					value="${data.地块地址}某某" maxlength="30" />
				编码 <input id="地块地址" name="地块地址" class="required span1" type="text"
					value="${data.地块地址}103" maxlength="3" />
					<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label for="地块地址" class="control-label">村、居委会:</label>
			<div class="controls">
				<input id="地块地址" name="地块地址" class="required input-small" type="text"
					value="${data.地块地址}某某" maxlength="30" />
				编码 <input id="地块地址" name="地块地址" class="required span1" type="text"
					value="${data.地块地址}201" maxlength="3" />
					<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="地块编码" name="地块编码" class="required input-small"
					readonly type="text" value="${data.地块编码}110111" maxlength="50" />
<c:choose>
	<c:when test="${true}">
				<span class="input-prepend">
				<span class="add-on">DK</span>
				<input id="地块编码" name="地块编码" class="required span1" style="ime-mode:disabled"
					type="text" value="001" maxlength="8" />
				</span>
					<span class="help-inline"><font color="red">*</font> </span>
	</c:when>
	<c:otherwise>
		...
		<div class="control-group">
			<label for="农户姓名" class="control-label">户主:</label>
			<div class="controls">
				<input id="农户姓名" name="农户姓名" type="text" value="${data.农户姓名}" maxlength="4" />
			</div>
		</div>
		<div class="control-group">
			<label for="农户电话" class="control-label">联系电话:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="经度" class="control-label">地块面积:</label>
			<div class="controls">
				<span class="input-append">
		...
		<div class="control-group">
			<label for="种植方式" class="control-label">地块照片:</label>
			<div class="controls">
              <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="../static/img/field6.jpg" alt="">
                    <div class="carousel-caption">
                      <p class="pull-left">拍摄时间: 2018-01-11</p>
                      <span class="pull-right"><button class="btn btn-small">删除</button></span>
                    </div>
                  </div>
                  <div class="item">
                    <img src="../static/img/field4.jpg" alt="">
                    <div class="carousel-caption">
                      <p class="pull-left">拍摄时间: 2018-01-11</p>
                      <span class="pull-right"><button class="btn btn-small">删除</button></span>
                    </div>
