...
<%@include file="/WEB-INF/views/common/message.jsp"%>
	<form id="inputForm" class="form-horizontal"
		...
		<div class="control-group">
			<label for="坡向" class="control-label">农药商品名称:</label>
			<div class="controls">
				<input id="经度" name="经度" class="required input" type="text" value="${data.经度}" maxlength="30" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>

		<div class="control-group">
			<label for="种植模式" class="control-label">农药类别:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="add-on">g/亩 或 ml/亩</span>
				</span>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			<label for="坡向" class="control-label">有效成分 1:</label>
			<div class="controls">
				<input id="经度" name="经度" class="required input" type="text" value="${data.经度}" />
				含量：
				<span class="input-append">
				<input id="经度" name="经度" class="required input-mini" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
		...
		<div class="control-group">
			<label for="坡向" class="control-label">有效成分 2:</label>
			<div class="controls">
				<input id="经度" name="经度" class="required input" type="text" value="${data.经度}" />
				含量：
				<span class="input-append">
		...
		<div class="control-group">
			<label for="坡向" class="control-label">有效成分 3:</label>
			<div class="controls">
				<input id="经度" name="经度" class="required input" type="text" value="${data.经度}" />
				含量：
				<span class="input-append">
