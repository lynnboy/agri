			...
			<div class="navbar-inner">
				...
				<ul class="nav pull-right" id="userControl">
					<li class="dropdown" id="userInfo"><a title="个人信息"
						...
						data-toggle="dropdown">您好, <c:out value="${dealer.name}" />&nbsp;
					</a></li>
					<li><a title="退出登录" href="${base}/d/logout">退出</a></li>
					<li>&nbsp;</li>
				</ul>
				...
				<div id="left" style="width: 160px; height: 401px;">
					<div class="accordion" id="menu-left">
						<div class="accordion-group">
							<div class="accordion-body in collapse" id="collapse"
								aria-expanded="false">
								<div class="accordion-inner">
									<ul class="nav nav-list">
										<li class="active"><a href="${base}/dealer/customerList"
											target="mainFrame"><i class="icon-user"></i>&nbsp;客户管理</a></li>
										<li><a href="${base}/dealer/orderList" target="mainFrame"><i
