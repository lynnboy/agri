...
<%@include file="/WEB-INF/views/common/message.jsp"%>
	<form id="inputForm" class="form-horizontal"
		...
		<div class="control-group">
			<label for="产流日期" class="control-label">种植日期:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="产流日期" class="control-label">收获日期:</label>
			<div class="controls">
				<input id="产流日期" name="产流日期" type="text" readonly="readonly"
					maxlength="20" class="ignore input-small Wdate" value=""
					onchange="return $(this).valid();"
		...
		<div class="control-group">
			<label for="坡向" class="control-label">经济产量:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="种植模式" class="control-label">作业方式:</label>
			<div class="controls">
				<select id="作物" name="种植模式" class="xreqselect input">
				<option>== 请选择 ==</option>
				<option>全程机械化</option>
				<option>半机械化</option>
				<option>人工作业</option>
		...
		<div class="control-group">
			<label for="种植模式" class="control-label">灌溉水源:</label>
			<div class="controls">
				<label class="radio inline">
				  <input type="radio" name="optionsRadios" id="optionsRadios1" value="1" checked>井水
				</label>
				<label class="radio inline">
				  <input type="radio" name="optionsRadios" id="optionsRadios1" value="2" checked>河水
				</label>
				<label class="radio inline">
				  <input type="radio" name="optionsRadios" id="optionsRadios1" value="2" checked>其他: 
				</label>
				<input id="经度" name="经度" class="input" disabled="disabled" type="text" value="${data.经度}" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>

		<div class="control-group">
			<label for="坡向" class="control-label">灌溉次数:</label>
			<div class="controls">
				<span class="input-append">
				<input id="经度" name="经度" class="required input-small" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
		...
		<div class="control-group">
			<label for="坡向" class="control-label">农药次数:</label>
			<div class="controls">
				<span class="input-append">
				<input id="经度" name="经度" class="required input-small" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
				<span class="add-on">次</span>
		...
		<div class="control-group">
			<label for="种植模式" class="control-label">是否覆盖地膜:</label>
			<div class="controls">
				<select id="作物" name="种植模式" class="xreqselect input">
				<option>== 请选择 ==</option>
				<option>是</option>
		...
		<div class="control-group">
			<label for="坡向" class="control-label">地膜厚度:</label>
			<div class="controls">
				<span class="input-append">
				<input id="经度" name="经度" class="required input-small" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
		...
		<div class="control-group">
			<label for="坡向" class="control-label">覆膜量:</label>
			<div class="controls">
				<span class="input-append">
				<input id="经度" name="经度" class="required input-small" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
				<span class="add-on">公斤/亩</span>
		...
		<div class="control-group">
			<label for="坡向" class="control-label">地膜回收量:</label>
			<div class="controls">
				<span class="input-append">
				<input id="经度" name="经度" class="required input-small" type="text" value="${data.经度}" maxlength="10" min="0" max="1000000" />
				<span class="add-on">公斤/亩</span>
