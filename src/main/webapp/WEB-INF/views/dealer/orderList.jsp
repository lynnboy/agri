...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${base}/dealer/orderList">订单列表</a></li>
		<li ><a href="${base}/dealer/orderCreate">订单申请</a></li>
	</ul>
	<form class="breadcrumb form-search " id="searchForm"
		action="${base}/dealer/orderList" method="get">
...
<c:forEach items='${orderList}' var='order'>
			<tr>
				...
				<td><a href="${base}/dealer/orderDeal?id=${order.id}">${order.status == 0 ? "处理" : "查看" }</a></td>
			</tr>
</c:forEach>
