	...
	<table class="table table-striped table-bordered table-condensed"
		...
		<tbody>
				...
				<tr>
					...
					<td>
						2 季 <a class="btn btn-primary btn-mini" href="${base}/survey/list2add1">查看</a>
					</td>
					<td>
						2 次 <a class="btn btn-primary btn-mini" href="${base}/survey/list2add2">查看</a>
					</td>
					<td>
						1 次 <a class="btn btn-primary btn-mini" href="${base}/survey/list2add3">查看</a>
					</td>
					<td>张三</td>
					<td></td>
					<td>2018-01-12</td>
				...
				<tr>
					...
					<td>【DB05】 东北半湿润平原区-旱地-其它大田作物</td>
					<td>
						0 季 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						0 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						0 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
				...
				<tr>
					...
					<td>
						2 季 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						1 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						0 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					...
					<td>
						<a class="btn btn-primary btn-mini" href="${base}/agri/edit?id=${item.id}">查看</a>
						<a class="btn btn-primary btn-mini" href="${base}/agri/process?id=${item.id}">通过审核</a>
						<a class="btn btn-primary btn-mini" href="${base}/agri/edit?id=${item.id}">返回</a>
					</td>
				</tr>
				...
				<tr>
					...
					<td>【DB04】 东北半湿润平原区-旱地-大豆</td>
					<td>
						1 季 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						2 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					<td>
						1 次 <a class="btn btn-primary btn-mini" href="${base}/survey/modelist">查看</a>
					</td>
					...
					<td>
						<a class="btn btn-primary btn-mini" href="${base}/agri/edit?id=${item.id}">查看</a>
						<a class="btn btn-primary btn-mini" href="${base}/agri/process?id=${item.id}">撤回审核</a>
					</td>
				</tr>
